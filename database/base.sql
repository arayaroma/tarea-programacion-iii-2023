...
CREATE TABLE EVACOMUNA."TBL_EVALUATED" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
    "EVALUATED" NUMBER(38, 0) NOT NULL ENABLE,
    ...
    --CONSTRAINT "TBL_EVALUATED_UK" UNIQUE ("EVALUATEDID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING TABLESPACE "USERS";

-- TABLE TBL_EVALUATOR
CREATE TABLE EVACOMUNA."TBL_EVALUATOR" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
    "EVALUATOR" NUMBER(38, 0) NOT NULL ENABLE,
   ...
   -- CONSTRAINT "TBL_EVALUATOR_UK" UNIQUE ("EVALUATORID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE,
...
COMMENT ON COLUMN EVACOMUNA.TBL_EVALUATOR.ROLE IS 'ROLES(SELF, SUPERVISOR, PEER, CLIENT)';
 ...
 ALTER TABLE EVACOMUNA."TBL_EVALUATOR" ADD CONSTRAINT "FK_TBL_EVALUATOR_TO_USER" FOREIGN KEY ("EVALUATOR") REFERENCES EVACOMUNA."TBL_USER" ("ID") ENABLE;
 -- FK TBL_EVALUATED -> TBL_USER
 ALTER TABLE EVACOMUNA."TBL_EVALUATED" ADD CONSTRAINT "FK_TBL_EVALUATED_TO_USER" FOREIGN KEY ("EVALUATED") REFERENCES EVACOMUNA."TBL_USER" ("ID") ENABLE;
 ...
 ALTER TABLE EVACOMUNA."TBL_CALIFICATION" ADD CONSTRAINT "FK_TBL_EVALUATOR_TO_CALIFICATION" FOREIGN KEY ("EVALUATOR") REFERENCES EVACOMUNA."TBL_EVALUATOR" ("ID") ENABLE;
