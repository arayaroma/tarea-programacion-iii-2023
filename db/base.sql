...
CREATE TABLE EVACOMUNA."TBL_AVERAGE_CALIFICATION" (
    "ID" NUMBER(38, 0) NOT NULL ENABLE,
...
COMMENT ON COLUMN EVACOMUNA.TBL_USER.ISADMIN IS 'N for false, Y for true';
 -- ALTERS
 -- FK TBL_USER -> TBL_EVALUATOR
 ALTER TABLE EVACOMUNA."TBL_USER" ADD CONSTRAINT "FK_TBL_USER_TO_EVALUATOR" FOREIGN KEY ("EVALUATORID") REFERENCES EVACOMUNA."TBL_EVALUATOR" ("ID") ENABLE;
 -- FK TBL_USER -> TBL_EVALUATED
 ALTER TABLE EVACOMUNA."TBL_USER" ADD CONSTRAINT "FK_TBL_USER_TO_EVALUATED" FOREIGN KEY ("EVALUATEDID") REFERENCES EVACOMUNA."TBL_EVALUATED" ("ID") ENABLE;
 ...
 -- FK TBL_CHARACTERISTIC -> TBL_SKILL
 ALTER TABLE EVACOMUNA."TBL_CHARACTERISTIC" ADD CONSTRAINT "FK_TBL_SKILL" FOREIGN KEY ("ID") REFERENCES "EVACOMUNA"."TBL_SKILL" ("ID") ENABLE;
 ...
 -- FK TBL_AVERAGE_CALIFICATION -> TBL_SKILL
 ALTER TABLE EVACOMUNA."TBL_AVERAGE_CALIFICATION" ADD CONSTRAINT "FK_TBL_SKILL_TO_AVERAGE_CALIFICATION" FOREIGN KEY ("SKILLID") REFERENCES EVACOMUNA."TBL_SKILL" ("ID") ENABLE;
 -- FK TBL_AVERAGE_CALIFICATION -> TBL_EVALUATED
 ALTER TABLE EVACOMUNA."TBL_AVERAGE_CALIFICATION" ADD CONSTRAINT "FK_TBL_EVALUATED_TO_AVERAGE_CALIFICATION" FOREIGN KEY ("EVALUATEDID") REFERENCES EVACOMUNA."TBL_EVALUATED" ("ID") ENABLE;
 -- ALTER TRIGGERS
