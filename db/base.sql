...
CREATE UNIQUE INDEX "EVACOMUNA"."TBL_EVALUATION_PK" ON "EVACOMUNA"."TBL_EVALUATION" ("ID")
...
CREATE OR REPLACE EDITIONABLE TRIGGER "EVACOMUNA"."TGR_POSITION" BEFORE
    INSERT ON TBL_POSITION FOR EACH ROW
BEGIN
    IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN
        :NEW.ID := SEQ_POSITION.NEXTVAL;
    END IF;
END;
/
...
CREATE UNIQUE INDEX "EVACOMUNA"."TBL_POSITION_PK" ON "EVACOMUNA"."TBL_POSITION" ("ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS";
...
CREATE OR REPLACE EDITIONABLE TRIGGER "EVACOMUNA"."TGR_SKILL" BEFORE
    INSERT ON TBL_SKILL FOR EACH ROW
BEGIN
    IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN
        :NEW.ID := SEQ_SKILL.NEXTVAL;
    END IF;
END;
/
...
CREATE UNIQUE INDEX "EVACOMUNA"."TBL_SKILL_PK" ON "EVACOMUNA"."TBL_SKILL" ("ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS";
...
CREATE OR REPLACE EDITIONABLE TRIGGER "EVACOMUNA"."TGR_USER" BEFORE
    INSERT ON TBL_USER FOR EACH ROW
BEGIN
    IF :NEW.ID IS NULL OR :NEW.ID <= 0 THEN
...
CREATE UNIQUE INDEX "EVACOMUNA"."TBL_USER_PK" ON "EVACOMUNA"."TBL_USER" ("ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS";
...
CREATE UNIQUE INDEX "EVACOMUNA"."TBL_USER_UK1" ON "EVACOMUNA"."TBL_USER" ("USERNAME")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS";

CREATE UNIQUE INDEX "EVACOMUNA"."TBL_USER_UK2" ON "EVACOMUNA"."TBL_USER" ("IDENTIFICATION")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  TABLESPACE "USERS";
