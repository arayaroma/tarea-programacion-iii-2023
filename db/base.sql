...
CREATE TABLE EVACOMUNA."TBL_EVALUATED" (
    ...
    "FINALNOTE" VARCHAR2(100) NOT NULL ENABLE,
    ...
    CONSTRAINT "TBL_EVALUATED_UK" UNIQUE ("EVALUATED") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE
) SEGMENT CREATION DEFERRED PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING TABLESPACE "USERS";
...
CREATE TABLE EVACOMUNA."TBL_EVALUATOR" (
    ...
    "FEEDBACK" VARCHAR2(100) NOT NULL ENABLE,
    ...
    CONSTRAINT "TBL_EVALUATOR_UK" UNIQUE ("EVALUATOR") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS TABLESPACE "USERS" ENABLE,
