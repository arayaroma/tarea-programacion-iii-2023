 ...
 * 2023-09-22T20:38:01.865-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "CharacteristicController",
                  wsdlLocation = "http://10.0.0.3:8080/evacomunaws/CharacteristicController?wsdl",
...
public class CharacteristicController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.0.0.3:8080/evacomunaws/CharacteristicController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CharacteristicController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://10.0.0.3:8080/evacomunaws/CharacteristicController?wsdl");
        }
        WSDL_LOCATION = url;
    }
