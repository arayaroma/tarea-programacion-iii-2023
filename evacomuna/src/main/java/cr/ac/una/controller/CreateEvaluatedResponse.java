...
/**
 * <p>Clase Java para createEvaluatedResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createEvaluatedResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "createEvaluatedResponse", propOrder = {
    "_return"
})
public class CreateEvaluatedResponse {
