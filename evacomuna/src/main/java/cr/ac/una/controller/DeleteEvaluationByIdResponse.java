...
/**
 * <p>Clase Java para deleteEvaluationByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteEvaluationByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteEvaluationByIdResponse", propOrder = {
    "_return"
})
public class DeleteEvaluationByIdResponse {
