...
/**
 * <p>Clase Java para deletePositionByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deletePositionByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deletePositionByIdResponse", propOrder = {
    "_return"
})
public class DeletePositionByIdResponse {
