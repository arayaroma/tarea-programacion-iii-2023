...
/**
 * <p>Clase Java para deleteSkillByNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteSkillByNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteSkillByNameResponse", propOrder = {
    "_return"
})
public class DeleteSkillByNameResponse {
