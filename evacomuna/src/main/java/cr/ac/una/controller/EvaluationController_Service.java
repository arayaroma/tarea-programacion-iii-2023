 ...
 * 2023-09-22T20:38:04.795-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "EvaluationController",
                  wsdlLocation = "http://10.0.0.3:8080/evacomunaws/EvaluationController?wsdl",
                  targetNamespace = "http://controller.una.ac.cr/")
public class EvaluationController_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://controller.una.ac.cr/", "EvaluationController");
    public final static QName EvaluationControllerPort = new QName("http://controller.una.ac.cr/", "EvaluationControllerPort");
    static {
        URL url = null;
        try {
            url = new URL("http://10.0.0.3:8080/evacomunaws/EvaluationController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EvaluationController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://10.0.0.3:8080/evacomunaws/EvaluationController?wsdl");
        }
        WSDL_LOCATION = url;
    }
