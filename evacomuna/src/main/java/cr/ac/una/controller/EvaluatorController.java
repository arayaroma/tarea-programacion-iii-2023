...
;
    ...
    @WebMethod
    @Action(input = "http://controller.una.ac.cr/EvaluatorController/getEvaluatorByEvaluatedIdRequest", output = "http://controller.una.ac.cr/EvaluatorController/getEvaluatorByEvaluatedIdResponse")
    @RequestWrapper(localName = "getEvaluatorByEvaluatedId", targetNamespace = "http://controller.una.ac.cr/", className = "cr.ac.una.controller.GetEvaluatorByEvaluatedId")
    @ResponseWrapper(localName = "getEvaluatorByEvaluatedIdResponse", targetNamespace = "http://controller.una.ac.cr/", className = "cr.ac.una.controller.GetEvaluatorByEvaluatedIdResponse")
    @WebResult(name = "return", targetNamespace = "")
    public cr.ac.una.controller.ResponseWrapper getEvaluatorByEvaluatedId(
