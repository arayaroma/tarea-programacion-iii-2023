...
public class FinalCalificationController_Service extends Service {
    ...
    public final static QName SERVICE = new QName("http://controller.una.ac.cr/", "FinalCalificationController");
    public final static QName FinalCalificationControllerPort = new QName("http://controller.una.ac.cr/", "FinalCalificationControllerPort");
    static {
        URL url = null;
        try {
