...
public interface GeneralInformationController {
    ...
    @WebMethod
    @Action(input = "http://controller.una.ac.cr/GeneralInformationController/deleteGeneralInformationRequest", output = "http://controller.una.ac.cr/GeneralInformationController/deleteGeneralInformationResponse")
    @RequestWrapper(localName = "deleteGeneralInformation", targetNamespace = "http://controller.una.ac.cr/", className = "cr.ac.una.controller.DeleteGeneralInformation")
    @ResponseWrapper(localName = "deleteGeneralInformationResponse", targetNamespace = "http://controller.una.ac.cr/", className = "cr.ac.una.controller.DeleteGeneralInformationResponse")
    @WebResult(name = "return", targetNamespace = "")
    public cr.ac.una.controller.ResponseWrapper deleteGeneralInformation(
