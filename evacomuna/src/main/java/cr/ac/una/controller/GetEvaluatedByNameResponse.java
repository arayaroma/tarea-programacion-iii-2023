...
/**
 * <p>Clase Java para getEvaluatedByNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getEvaluatedByNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getEvaluatedByNameResponse", propOrder = {
    "_return"
})
public class GetEvaluatedByNameResponse {
