...
/**
 * <p>Clase Java para getEvaluationByNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getEvaluationByNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getEvaluationByNameResponse", propOrder = {
    "_return"
})
public class GetEvaluationByNameResponse {
