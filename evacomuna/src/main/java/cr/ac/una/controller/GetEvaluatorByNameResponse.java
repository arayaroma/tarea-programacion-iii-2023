...
/**
 * <p>Clase Java para getEvaluatorByNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getEvaluatorByNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getEvaluatorByNameResponse", propOrder = {
    "_return"
})
public class GetEvaluatorByNameResponse {
