...
/**
 * <p>Clase Java para getGeneralInformationResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getGeneralInformationResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getGeneralInformationResponse", propOrder = {
    "_return"
})
