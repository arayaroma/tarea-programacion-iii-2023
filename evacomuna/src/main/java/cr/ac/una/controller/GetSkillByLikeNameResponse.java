...
/**
 * <p>Clase Java para getSkillByLikeNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getSkillByLikeNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getSkillByLikeNameResponse", propOrder = {
    "_return"
})
public class GetSkillByLikeNameResponse {
