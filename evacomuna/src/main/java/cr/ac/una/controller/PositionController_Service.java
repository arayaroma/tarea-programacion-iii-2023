 ...
 * 2023-09-22T20:38:04.412-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "PositionController",
                  wsdlLocation = "http://10.0.0.3:8080/evacomunaws/PositionController?wsdl",
...
public class PositionController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.0.0.3:8080/evacomunaws/PositionController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PositionController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://10.0.0.3:8080/evacomunaws/PositionController?wsdl");
        }
        WSDL_LOCATION = url;
    }
