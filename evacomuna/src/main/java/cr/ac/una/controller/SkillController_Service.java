 ...
 * 2023-09-22T20:38:02.431-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "SkillController",
                  wsdlLocation = "http://10.0.0.3:8080/evacomunaws/SkillController?wsdl",
...
public class SkillController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.0.0.3:8080/evacomunaws/SkillController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SkillController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://10.0.0.3:8080/evacomunaws/SkillController?wsdl");
        }
        WSDL_LOCATION = url;
    }
