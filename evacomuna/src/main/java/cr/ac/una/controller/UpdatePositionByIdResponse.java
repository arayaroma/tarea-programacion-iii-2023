...
/**
 * <p>Clase Java para updatePositionByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updatePositionByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "updatePositionByIdResponse", propOrder = {
    "_return"
})
public class UpdatePositionByIdResponse {
