 ...
 *         &lt;element name="evaluated" type="{http://controller.una.ac.cr/}evaluated" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="position" type="{http://controller.una.ac.cr/}position" minOccurs="0"/&gt;
...
public class User {
    ...
    protected List<Evaluated> evaluated;
    @XmlElement(nillable = true)
