 ...
 * 2023-09-24T09:56:00.227-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "UserController",
                  wsdlLocation = "http://10.0.0.3:8080/evacomunaws/UserController?wsdl",
...
public class UserController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.0.0.3:8080/evacomunaws/UserController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://10.0.0.3:8080/evacomunaws/UserController?wsdl");
        }
        WSDL_LOCATION = url;
    }
