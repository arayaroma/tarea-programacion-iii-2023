...
public class SkillModuleController implements Initializable {
    ...
    FinalCalificationService finalCalificationService = new FinalCalificationService();
    // BUFFERS
    ...
    private void btnDeleteSkill(ActionEvent event) {
        if (skillBufferMainView != null) {
            ...
            if (skillBufferMainView.getFinalCalifications() != null) {
                skillBufferMainView.getFinalCalifications().forEach(t -> finalCalificationService.deleteFinalCalificationById(t.getID()));
            }
