    ...
    public EvaluationDto convertFromGeneratedToDTO(cr.ac.una.evacomunaws.controller.EvaluationDto generated,
        ...
        if (dto.getEvaluated() != null) {
            for (int i = 0; i < dto.getEvaluated().size(); i++) {
                dto.getEvaluated()
                        .get(i).setFinalCalifications(DtoMapper
                                .fromGeneratedList(generated.getEvaluated()
                                        .get(i).getFinalCalifications(), FinalCalificationDto.class)
                                .getList());
                if (dto.getEvaluated().get(i).getFinalCalifications() != null) {
                    for (int j = 0; j < dto.getEvaluated().get(i).getFinalCalifications().size(); j++) {
                        dto.getEvaluated()
                                .get(i).getFinalCalifications()
                                .get(j).setSkill(new SkillDto(generated.getEvaluated()
                                        .get(i).getFinalCalifications()
                                        .get(j)
                                        .getSkill()));
                    }
                ...
                dto.getEvaluated()
                        .get(i).setEvaluated(new UserDto(generated.getEvaluated()
                                .get(i)
                                .getEvaluated()));
                dto.getEvaluated()
