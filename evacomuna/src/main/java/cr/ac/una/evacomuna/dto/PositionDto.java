...
public class PositionDto implements DtoMapper<cr.ac.una.evacomunaws.controller.PositionDto, PositionDto> {
    ...
    public cr.ac.una.evacomunaws.controller.PositionDto convertFromDTOToGenerated(PositionDto dto,
        ...
        //dto.getUsers().forEach(t -> generated.getUsers().add();
//        generated.getUsers()
//                .addAll(DtoMapper.fromGeneratedList(dto.getUsers(), cr.ac.una.evacomunaws.controller.UserDto.class).getList());
//        generated.getSkills()
//                .addAll(DtoMapper.fromGeneratedList(dto.getSkills(), cr.ac.una.evacomunaws.controller.SkillDto.class).getList());
