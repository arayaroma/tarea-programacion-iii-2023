 ...
 * 2023-10-02T01:01:37.170-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "CharacteristicController",
                  wsdlLocation = "http://192.168.0.24:8080/evacomunaws/CharacteristicController?wsdl",
...
public class CharacteristicController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.24:8080/evacomunaws/CharacteristicController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CharacteristicController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.24:8080/evacomunaws/CharacteristicController?wsdl");
        }
        WSDL_LOCATION = url;
    }
