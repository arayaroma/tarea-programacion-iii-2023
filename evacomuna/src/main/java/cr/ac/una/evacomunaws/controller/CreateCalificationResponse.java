...
/**
 * <p>Clase Java para createCalificationResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createCalificationResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "createCalificationResponse", propOrder = {
    "_return"
})
public class CreateCalificationResponse {
