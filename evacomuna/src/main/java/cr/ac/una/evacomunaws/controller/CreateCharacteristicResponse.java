...
/**
 * <p>Clase Java para createCharacteristicResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createCharacteristicResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "createCharacteristicResponse", propOrder = {
    "_return"
})
