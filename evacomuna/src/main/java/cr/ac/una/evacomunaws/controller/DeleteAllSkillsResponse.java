...
/**
 * <p>Clase Java para deleteAllSkillsResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteAllSkillsResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteAllSkillsResponse", propOrder = {
    "_return"
})
public class DeleteAllSkillsResponse {
