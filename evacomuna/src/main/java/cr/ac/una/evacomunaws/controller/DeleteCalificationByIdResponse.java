...
/**
 * <p>Clase Java para deleteCalificationByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteCalificationByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteCalificationByIdResponse", propOrder = {
    "_return"
})
public class DeleteCalificationByIdResponse {
