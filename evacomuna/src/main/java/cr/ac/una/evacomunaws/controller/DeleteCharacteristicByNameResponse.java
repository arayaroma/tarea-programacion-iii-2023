...
/**
 * <p>Clase Java para deleteCharacteristicByNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteCharacteristicByNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteCharacteristicByNameResponse", propOrder = {
    "_return"
})
public class DeleteCharacteristicByNameResponse {
