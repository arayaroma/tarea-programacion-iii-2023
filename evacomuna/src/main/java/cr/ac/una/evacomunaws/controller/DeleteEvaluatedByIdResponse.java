...
/**
 * <p>Clase Java para deleteEvaluatedByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteEvaluatedByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteEvaluatedByIdResponse", propOrder = {
    "_return"
})
public class DeleteEvaluatedByIdResponse {
