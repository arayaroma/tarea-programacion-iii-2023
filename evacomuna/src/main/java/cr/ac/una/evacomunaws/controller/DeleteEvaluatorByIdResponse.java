...
/**
 * <p>Clase Java para deleteEvaluatorByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteEvaluatorByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteEvaluatorByIdResponse", propOrder = {
    "_return"
})
public class DeleteEvaluatorByIdResponse {
