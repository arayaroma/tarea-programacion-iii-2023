...
/**
 * <p>Clase Java para deleteSkillByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteSkillByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteSkillByIdResponse", propOrder = {
    "_return"
})
public class DeleteSkillByIdResponse {
