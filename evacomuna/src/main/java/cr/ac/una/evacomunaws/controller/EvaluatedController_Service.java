 ...
 * 2023-10-02T01:01:39.184-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "EvaluatedController",
                  wsdlLocation = "http://192.168.0.24:8080/evacomunaws/EvaluatedController?wsdl",
                  targetNamespace = "http://controller.evacomunaws.una.ac.cr/")
public class EvaluatedController_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://controller.evacomunaws.una.ac.cr/", "EvaluatedController");
    public final static QName EvaluatedControllerPort = new QName("http://controller.evacomunaws.una.ac.cr/", "EvaluatedControllerPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.24:8080/evacomunaws/EvaluatedController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EvaluatedController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.24:8080/evacomunaws/EvaluatedController?wsdl");
        }
        WSDL_LOCATION = url;
    }
