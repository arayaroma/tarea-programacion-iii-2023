 ...
 * 2023-10-02T01:01:38.434-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "EvaluationController",
                  wsdlLocation = "http://192.168.0.24:8080/evacomunaws/EvaluationController?wsdl",
...
public class EvaluationController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.24:8080/evacomunaws/EvaluationController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EvaluationController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.24:8080/evacomunaws/EvaluationController?wsdl");
        }
        WSDL_LOCATION = url;
    }
