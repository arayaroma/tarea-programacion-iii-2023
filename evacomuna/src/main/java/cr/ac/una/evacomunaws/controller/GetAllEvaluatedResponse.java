...
/**
 * <p>Clase Java para getAllEvaluatedResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getAllEvaluatedResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getAllEvaluatedResponse", propOrder = {
    "_return"
})
public class GetAllEvaluatedResponse {
