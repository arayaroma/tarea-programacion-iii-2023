...
/**
 * <p>Clase Java para getAllEvaluationResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getAllEvaluationResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getAllEvaluationResponse", propOrder = {
    "_return"
})
public class GetAllEvaluationResponse {
