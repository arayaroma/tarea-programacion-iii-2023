...
/**
 * <p>Clase Java para getAllEvaluatorResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getAllEvaluatorResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getAllEvaluatorResponse", propOrder = {
    "_return"
})
public class GetAllEvaluatorResponse {
