...
/**
 * <p>Clase Java para getAllFinalCalificationResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getAllFinalCalificationResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getAllFinalCalificationResponse", propOrder = {
    "_return"
})
public class GetAllFinalCalificationResponse {
