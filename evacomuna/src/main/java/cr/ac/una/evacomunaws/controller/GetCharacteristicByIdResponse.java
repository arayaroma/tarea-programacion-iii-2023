...
/**
 * <p>Clase Java para getCharacteristicByIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getCharacteristicByIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getCharacteristicByIdResponse", propOrder = {
    "_return"
})
public class GetCharacteristicByIdResponse {
