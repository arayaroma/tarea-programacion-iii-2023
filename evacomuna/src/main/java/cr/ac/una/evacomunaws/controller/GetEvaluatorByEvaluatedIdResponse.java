...
/**
 * <p>Clase Java para getEvaluatorByEvaluatedIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getEvaluatorByEvaluatedIdResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getEvaluatorByEvaluatedIdResponse", propOrder = {
    "_return"
})
public class GetEvaluatorByEvaluatedIdResponse {
