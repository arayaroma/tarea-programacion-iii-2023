...
/**
 * <p>Clase Java para getFinalNoteResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getFinalNoteResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getFinalNoteResponse", propOrder = {
    "_return"
})
public class GetFinalNoteResponse {
