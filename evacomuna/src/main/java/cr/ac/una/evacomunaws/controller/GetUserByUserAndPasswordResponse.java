...
/**
 * <p>Clase Java para getUserByUserAndPasswordResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUserByUserAndPasswordResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUserByUserAndPasswordResponse", propOrder = {
    "_return"
})
public class GetUserByUserAndPasswordResponse {
