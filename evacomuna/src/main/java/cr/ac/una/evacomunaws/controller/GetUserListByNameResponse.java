...
/**
 * <p>Clase Java para getUserListByNameResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUserListByNameResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUserListByNameResponse", propOrder = {
    "_return"
})
public class GetUserListByNameResponse {
