 ...
 * 2023-10-02T01:01:37.587-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "SkillController",
                  wsdlLocation = "http://192.168.0.24:8080/evacomunaws/SkillController?wsdl",
...
public class SkillController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.24:8080/evacomunaws/SkillController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SkillController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.24:8080/evacomunaws/SkillController?wsdl");
        }
        WSDL_LOCATION = url;
    }
