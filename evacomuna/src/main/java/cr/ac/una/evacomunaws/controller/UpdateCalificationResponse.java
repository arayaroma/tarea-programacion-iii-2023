...
/**
 * <p>Clase Java para updateCalificationResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updateCalificationResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "updateCalificationResponse", propOrder = {
    "_return"
})
public class UpdateCalificationResponse {
