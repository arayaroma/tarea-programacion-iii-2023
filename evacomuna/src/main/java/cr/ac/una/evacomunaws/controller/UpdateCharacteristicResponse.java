...
/**
 * <p>Clase Java para updateCharacteristicResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updateCharacteristicResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "updateCharacteristicResponse", propOrder = {
    "_return"
})
public class UpdateCharacteristicResponse {
