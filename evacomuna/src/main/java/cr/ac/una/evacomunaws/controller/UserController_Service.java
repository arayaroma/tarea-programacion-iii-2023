...
<<<<<<< HEAD
 * 2023-09-28T02:53:44.705-06:00
=======
 * 2023-09-28T02:30:02.003-06:00
...
public class UserController_Service extends Service {
    ...
    public final static QName SERVICE = new QName("http://controller.evacomunaws.una.ac.cr/", "UserController");
    public final static QName UserControllerPort = new QName("http://controller.evacomunaws.una.ac.cr/", "UserControllerPort");
    static {
        URL url = null;
        try {
