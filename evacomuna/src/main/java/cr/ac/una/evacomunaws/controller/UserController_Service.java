 ...
 * 2023-10-02T01:01:36.715-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "UserController",
                  wsdlLocation = "http://192.168.0.24:8080/evacomunaws/UserController?wsdl",
...
public class UserController_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.24:8080/evacomunaws/UserController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.24:8080/evacomunaws/UserController?wsdl");
        }
        WSDL_LOCATION = url;
    }
