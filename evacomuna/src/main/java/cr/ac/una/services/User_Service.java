...
public class User_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/estebannajera/Desktop/tarea-programacion-iii-2023/evacomuna/src/main/resources/user.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(User_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/estebannajera/Desktop/tarea-programacion-iii-2023/evacomuna/src/main/resources/user.wsdl");
        }
        WSDL_LOCATION = url;
    }
