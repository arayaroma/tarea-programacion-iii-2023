 ...
 * 2023-08-19T19:41:07.280-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "User",
                  wsdlLocation = "file:/home/araya/Repositories/tarea-programacion-iii-2023/evacomuna/src/main/resources/wsdl/user.wsdl",
                  targetNamespace = "http://impl.services.una.ac.cr/")
public class User_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.services.una.ac.cr/", "User");
    public final static QName UserServiceImplPort = new QName("http://impl.services.una.ac.cr/", "UserServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/araya/Repositories/tarea-programacion-iii-2023/evacomuna/src/main/resources/wsdl/user.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(User_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/araya/Repositories/tarea-programacion-iii-2023/evacomuna/src/main/resources/wsdl/user.wsdl");
        }
        WSDL_LOCATION = url;
    }
